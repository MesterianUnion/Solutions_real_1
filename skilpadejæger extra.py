...
def hunt(prey_class, hunter_class, color):  # execute the hunt
    ...
    turtle.clearscreen()
    if turn < MAX_TURNS:
        print(f'Fanget efter {turn} runder.')
    else:
        print(f'Byttedyr, var ikke fanget efter {turn} runder. Byttedyr modtager {turn} bonus point.')
        turn *= 2
    return turn
# endregion
...
class1 = Byttedyr  # (red prey) Replace PlayerName1 by your own class name here.
class2 = Rovdyr  # (green prey) For testing your code, replace PlayerName2 by your own class name here. Later replace this by your sparring partner's class name.
# endregion
