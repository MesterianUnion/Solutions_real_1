...
if __name__ == "__main__":
    ...
    expression_field = Entry(gui, textvariable=equation, width=55, )
    ...
    button7.grid(row=4, column=0, pady=1)
    ...
    button0.grid(row=5, column=0, pady=1)
    ...
    Decimal = Button(gui, text='.', fg='black', bg='red',
                     command=lambda: press('.'), height=2, width=15)
    Decimal.grid(row=6, column=0, pady=1)
    # start the GUI
    gui.mainloop()
