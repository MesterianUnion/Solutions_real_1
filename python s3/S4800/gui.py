...
class BotControlGUI:
    ...
    #     bot.stop_bot()
    def stop_bot(self):
        global is_bot_visible
        is_bot_visible = False  # Hide the bot
    ...
    #     channel = client.get_channel(1158338847491502080)
    #     client.loop.create_task(channel.send('/shutdown'))
...
#STOP THE DISCORD BOT FROM RUNNING
    def stop_bot():
        stop_bot()
